...
final class DiagnosticPolicy {
    ...
    private static final Set<String> STAGES = words("start ready error done cancelled busy permission load initialize dispatch stream connect parse write read export import check download verify install confirm timeout");
